...
public class UtilidadesBD {
    private static final String URL_DB_ORACLE = "jdbc:oracle:thin:@localhost:31521/XEPDB1";
    private static final String USER_DB_ORACLE = "nana";
    private static final String PASSWORD_DB_ORACLE="nana2025";
